            ...
            <div class="col-md-12">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb p-0 bg-white">
                        <li class="breadcrumb-item"><a href="index.php"><?= $this->lang->line('utama:beranda'); ?></a></li>
                        <li class="breadcrumb-item page active" aria-current="page"><?= $this->lang->line('utama:kontak'); ?></li>
                    </ol>
                </nav>
                <!-- Page Title -->
                <div class="d-block">
                    <h1 class="mb-lg-4 mb-3"><?= $this->lang->line('utama:kontak'); ?></h1>
                </div>
                <!-- Content -->
                <div class="d-block">
                    <div class="row">
                        
                        <div class="col-md-4 mb-lg-4 mb-5 order-md-2">
                            <h5>Direktorat Kemahasiswaan Institut Teknologi Bandung</h5>
                            <p class="m-0">Gedung CC Barat, Lantai 1</p>
                            <p class="m-0">Jalan Ganesa No 10</p>
                            <p class="m-0">Bandung, Jawabarat. Indonesia</p>
                            <table>
                                <tr>
                                    <td>Telp</td>
                                    <td>: (022) 2534275</td>
                            ...
                            <br>
                            <h6>Email</h6>
                            <a href="mailto:informasi@kemahasiswaan.itb.ac.id">informasi@kemahasiswaan.itb.ac.id</a>
                            <br>
                            <br>
                            <h6>Media Sosial</h6>
