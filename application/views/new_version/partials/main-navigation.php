...
<style>
    .menu-list--btn:focus {
        background-color: #F2F7FC; /* Adding background for better contrast */
    }
    ...
    .main-nav--menu-list .menu-list--btn:focus {
        background-color: #F2F7FC; /* Adding background for better contrast */
...
<div class="main-nav shadow-sm">
    ...
    <div class="main-nav--menu-list">
        <a href="<?= base_url('beranda') ?>" class="menu-list--btn" tabindex="0">
            <?= strtoupper($this->lang->line('utama:beranda')); ?>
        </a>
    </div>

    <!-- Dropdown: Profil -->
    <div class="main-nav--menu-list menu-list--dropdown">
        <button type="button" class="menu-list--btn"
                aria-haspopup="true"
                aria-expanded="false"
                aria-controls="profilDropdown"
                id="profilMenuBtn">
            <?= strtoupper($this->lang->line('utama:profil')); ?>
        </button>
        <div class="menu-list--dropdown-content" id="profilDropdown" aria-labelledby="profilMenuBtn">
    ...
    <!-- Mega Dropdown: Tautan -->
    <div class="main-nav--menu-list menu-list--dropdown">
        <button type="button" class="menu-list--btn"
                aria-haspopup="true"
                aria-expanded="false"
                aria-controls="tautanDropdown"
                id="tautanMenuBtn">
            <?= strtoupper($this->lang->line('utama:tautan')); ?>
        </button>
        <div class="menu-list--dropdown-content" id="tautanDropdown" aria-labelledby="tautanMenuBtn">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        dropdowns.forEach(dropdown => {
            ...
            dropdown.addEventListener('focusout', (e) => {
                // If the newly focused element is NOT inside this dropdown
